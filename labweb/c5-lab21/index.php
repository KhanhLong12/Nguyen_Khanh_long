...
<body>
	...
	?>
 <div align="center">
   <table width="1100" height="541">
     <tr>
       <td height="159" colspan="2"><img src="images/bacho.jpg" width="1092" height="154" /></td>
     </tr>
     <tr>
       <td width="199" bgcolor="#E2E2E2"></td>
       <td width="885" height="38" bgcolor="#E2E2E2">
       ...
       <td>
       		<?php
            	...
            	switch($ac)
				{
					...
					break;
					case "engvi": require_once("pages/vi-eng.php");
					break;
				}
			?>
